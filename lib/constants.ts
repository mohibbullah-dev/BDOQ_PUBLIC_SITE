...
export const API_BASE =
  process.env.NEXT_PUBLIC_API_URL || "https://bdoq-academy.onrender.com/api";
...
export const VIDEO_CATEGORIES = [
  { id: "all" as const, labelKey: "allVideos" },
  { id: "quran-learning" as const, labelKey: "quranLearning" },
  { id: "tajweed" as const, labelKey: "tajweed" },
  { id: "courses" as const, labelKey: "courses" },
  { id: "student-stories" as const, labelKey: "studentStories" },
] as const;
