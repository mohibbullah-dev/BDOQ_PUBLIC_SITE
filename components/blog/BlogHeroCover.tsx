    ...
    <div className="relative overflow-hidden rounded-2xl border border-white/20 shadow-2xl">
      ...
      <div className="absolute inset-0 flex flex-col justify-between p-4 sm:p-5">
        <div className="flex items-start justify-between gap-3">
          <span className="rounded-full border border-white/25 bg-black/30 px-3 py-1 font-body text-[11px] font-bold uppercase tracking-wider text-white backdrop-blur-sm">
            {primaryTag}
          </span>
          <span className="inline-flex items-center gap-1.5 rounded-full border border-white/20 bg-black/30 px-2.5 py-1 font-body text-xs font-semibold text-white backdrop-blur-sm">
        ...
        <div className="rounded-xl border border-white/20 bg-black/35 p-4 backdrop-blur-md">
          <div className="mb-2 flex items-center gap-2 text-white/90">
            ...
            <span className="font-body text-[10px] font-bold uppercase tracking-[0.18em] sm:text-xs">
              {t("academyBlog")}
            </span>
          </div>
