      ...
      <div className="p-3 sm:p-5 md:p-6">
        <div className="mb-3 flex items-center justify-between gap-2 sm:mb-4 sm:gap-3">
          <div className="flex min-w-0 items-center gap-2">
            ...
            <span className="truncate font-inter text-xs font-bold uppercase tracking-wide text-[#0D4A2F] sm:text-sm">
              Live Class Queue
            </span>
          </div>
          <span
                  ...
                  >
                    <div className="flex items-start justify-between gap-2 sm:gap-3">
                      <div className="min-w-0 flex-1">
                        <p className="truncate font-inter text-sm font-bold text-[#0D4A2F] sm:text-base">
                      ...
                      {session.status === "live" ? (
                        <span
                          className={heroLiveBadge("text-[9px] sm:text-[10px]")}
                        >
                          <Radio
                    ...
                    <div className="mt-2 flex items-center justify-between gap-2 border-t border-gray-100 pt-2 font-inter text-[10px] sm:mt-3 sm:pt-3 sm:text-xs">
                      <span className="flex min-w-0 items-center gap-1 font-semibold text-[#1B6B44]">
                        <GraduationCap
                          className="h-3.5 w-3.5 shrink-0 text-[var(--gold)] sm:h-4 sm:w-4"
                          aria-hidden="true"
                        />
                        <span className="truncate">{session.teacherLabel}</span>
                      </span>
        ...
        >
          ...
          <div className="flex items-center justify-between gap-2 sm:gap-3">
            ...
            <div className="shrink-0 text-right">
              <p className="font-inter text-lg font-bold text-[#0D4A2F] sm:text-xl">
